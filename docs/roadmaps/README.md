...
| **Vanilla Ability Edit** | **Started** — Phase 1 (read-only reference browser) confirmed in-game 2026-08-17 | [vanilla-ability-edit.md](started/vanilla-ability-edit.md) |
...
| [vanilla-ability-edit.md](started/vanilla-ability-edit.md) | Open / override shipped abilities; research-first, Phase 1 read-only reference browser confirmed in-game 2026-08-17 |
